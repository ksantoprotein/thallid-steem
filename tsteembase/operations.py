...
# Сериализатор
# https://github.com/steemit/steem-js/blob/master/src/auth/serializer/src/operations.js
...
type_op = {
	...
	#"account_update":					[['account', String], ['owner', Optional(Permission)], ['active', Optional(Permission)], 
	#										['posting', Optional(Permission)], ['memo_key', PublicKey], ['json_metadata', String]],
	...
	#"delegate_vesting_shares_with_interest":	[['delegator', String], ['delegatee', String], ['vesting_shares', Amount],
